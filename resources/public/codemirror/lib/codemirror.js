...
window.CodeMirror = (function() {
  ...
  function CodeMirror(place, options) {
    ...
    this.view = {
      ...
      sel: {from: {line: 0, ch: 0}, to: {line: 0, ch: 0}, inverted: false, shift: false, mark: false},
  ...
  function getSelectionRoot(view) {return view.sel.shift || view.sel.mark;}

  function setShift(view, val) {
    if (val) view.sel.shift = getSelectionRoot(view) || selHead(view);
    else view.sel.shift = null;
  }
  function setSelectionUser(cm, from, to, bias) {
    var view = cm.view, sh = getSelectionRoot(view);
    if (sh) {
  ...
  CodeMirror.prototype = {
    ...
    setSelectionMark: operation(null, function(mark) {
      this.view.sel.mark = mark;
    }),

    getSelectionMark: function() {
      return this.view.sel.mark;
    },
    ...
    moveH: operation(null, function(dir, unit) {
      ...
      if (getSelectionRoot(this.view) || posEq(sel.from, sel.to)) pos = findPosH(this, dir, unit, true);
